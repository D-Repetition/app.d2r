          ...
          <div className="w-full grid grid-cols-4">
              ...
              >
                  ...
                  <div className="flex h-full flex-col items-center justify-start gap-3">
                      ...
                      <img src="/images/selection-step/illustration-1.png" className='h-[20vh]' alt="Illustration 1" />
                  </div>
              </div>
              <div
                  className={[
              ...
              >
                  ...
                  <div className="flex h-full flex-col items-center justify-start gap-3">
                      ...
                      <img src="/images/selection-step/illustration-2.png" className='h-[20vh]' alt="Illustration 1" />
              ...
              >
                  ...
                  <div className="flex h-full flex-col items-center justify-start gap-3">
                      ...
                      <img src="/images/selection-step/illustration-3.png" className='h-[20vh]' alt="Illustration 1" />
              ...
              >
                  <div className="flex h-full flex-col items-center justify-start gap-3">
                      ...
                      <img src="/images/selection-step/illustration-4.png" className='h-[20vh]' alt="Illustration 1" />
