...
const Hero = () => {
    return (
        <section className="w-full min-h-svh mx-auto flex flex-col items-center pt-30 lg:pt-44 pb-12 lg:pb-10 justify-center max-lg:gap-6 lg:gap-[75px]">
            <div className="w-full max-lg:max-w-[90%] max-lg:mx-auto flex flex-col items-center justify-start max-lg:gap-8 lg:gap-15">
                <div className="flex flex-col items-center justify-start gap-8 w-full">
                    ...
                    <Image src={Images.Users} className="max-lg:h-12 lg:h-[8vh] w-auto object-contain" alt="Illustration enseignants et eleves" />
                    <div className="flex items-center justify-center gap-2"><Image src={Images.Verify} className="w-auto object-contain" alt="Badge verification des enseignants" /><span className="max-lg:text-[12px]">Plus de 50 répétiteurs vérifiés</span></div>
