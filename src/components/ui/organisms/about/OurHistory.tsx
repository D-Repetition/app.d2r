...
const OurHistory = () => {
    return (
        <section className='min-h-svh w-full bg-sky-blue relative'>
            <div className="w-full max-w-[90%] mx-auto min-h-svh flex flex-col items-start justify-between py-[6vh]">
                <div className="flex flex-col items-start justify-start gap-10.5">
                    ...
                    <p className="max-lg:w-full lg:max-w-[45%] lg:text-[1.25vw] lg:leading-[2.2vw] text-board-black/80">
                ...
                <Image src={Images.CurveU2} className='max-lg:h-20 lg:h-[16vh] w-auto object-contain' alt="Motif decoratif courbe" />
            </div>
            <Image src={Images.Curve2} className='hidden lg:block absolute top-0 bottom-0 right-0 h-svh w-auto object-contain' alt="Motif decoratif lateral" />
        </section>
    )
}
