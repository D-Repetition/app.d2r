              ...
              <div className="w-full max-w-[80%] h-[75vh] grid grid-cols-3 grid-rows-3">
                  ...
                  >
                      ...
                      <div className="flex h-full flex-col items-start justify-start gap-3">
                          <div className="font-dm-serif text-[1.7vw] leading-[2vw] text-board-black/90">
                              Validation des cours
                          </div>

                          <div className="text-[.9vw] text-board-black/80">
                  ...
                  >
                      <img src="/images/commit/commit.png" className='h-[15vh]' alt="Commit-1" />
                  </div>
                  <div
                      className={[
                          "max-w-[20vw]  shrink-0 p-[2vw] relative",
                  ...
                  >
                      <img src="/images/commit/commit-2.png" className='h-[15vh]' alt="Commit-1" />
                  </div>
                  <div
                      className={[
                          "max-w-[20vw]  shrink-0 p-[2vw] relative",
