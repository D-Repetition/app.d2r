            ...
            <div className="w-full max-w-[90%] mx-auto min-h-svh flex flex-col items-center justify-start py-[6vh] gap-12">
                ...
                <div className="w-full flex flex-col items-center justify-start gap-11">
                    <div className="w-full h-[65vh] relative flex items-center justify-center">
                        ...
                        <Image src={Images.HomeFly} className="z-100 h-[14vh] rotate-z-10 rotate-y-180 absolute top-6 right-12 w-auto object-contain" alt="Element graphique decoratif" />
                    ...
                    <div className="flex items-center justify-center w-full gap-2">
                        <Image src={Images.Info} className='h-[2vh] grayscale w-auto object-contain' alt="Icone information" />
