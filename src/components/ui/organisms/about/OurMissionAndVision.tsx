...
const OurMissionAndVision = () => {
    return (
        <section className='min-h-svh w-full relative'>
            <Image src="/images/curve-cyan.png" className='absolute left-0 bottom-0 h-[30vh]' alt="Curve cyan" />
                ...
                <div className="w-full h-[85vh] grid grid-cols-2 gap-[8vw]">
                    <div className="flex flex-col items-start">
                        <div className="flex flex-col items-start justify-start gap-8 lg:gap-[3vh]">
                            <div className="flex flex-col items-start justify-start gap-1">
                                <Image src="/images/goat.png" className="h-[10vh]" alt="Goat" />
                            ...
                            <div className="flex items-start gap-9">
                                <div className="flex flex-col items-start gap-3">
                                    <Image src="/images/student.png" className="h-[4vh]" alt="Student" />
                                ...
                                <div className="flex flex-col items-start gap-3">
                                    <Image src="/images/teacher.png" className="h-[4vh]" alt="Teacher" />
                    ...
                    <div className="flex flex-col items-start justify-center">
                        <div className="flex flex-col items-start justify-center gap-8 lg:gap-[3vh]">
                            <div className="flex flex-col items-start justify-start gap-1">
                                <Image src="/images/lion.png" className="h-[10vh]" alt="Lion" />
