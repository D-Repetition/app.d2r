        ...
        <section className='h-fit w-full'>
            <div className="w-full max-w-[90%] mx-auto min-h-[80vh] flex flex-col items-center justify-between py-[8vh] gap-12">
                <div className="flex max-lg:flex-col items-start justify-between gap-6 w-full lg:h-[40vh]">
                    <div className="flex flex-col items-start justify-start gap-2 text-board-black lg:max-w-[45%] h-full">
                        <div className="title text-start">Une méthode pensée pour la réussite de chaque élève</div>
                    </div>
                    <div className="flex flex-col items-start justify-start gap-6 h-full lg:max-w-[45%]">
                ...
                <div className="w-full flex flex-col items-center justify-start gap-11">
                    <div className="w-full max-lg:grid max-lg:grid-cols-2 max-lg:gap-3 gap-y-8 lg:flex items-center justify-between">
                        <div className="flex flex-col lg:items-start items-center gap-3">
                            <Image src={Images.HowItWorkIllustration5} className='h-[12vh] w-auto object-contain' alt="Illustration enseignants qualifies" />
                            <div className="simpleText font-normal! max-lg:text-[12px]! max-lg:leading-[14px]! max-lg:text-center!">Enseignants qualifiés</div>
                        </div>
                        <div className="flex flex-col lg:items-start items-center gap-3">
                            <Image src={Images.HowItWorkIllustration6} className='h-[12vh] w-auto object-contain' alt="Illustration approche inspiree des neurosciences" />
                        ...
                        <div className="flex flex-col lg:items-start items-center gap-3">
                            <Image src={Images.HowItWorkIllustration7} className='h-[12vh] w-auto object-contain' alt="Illustration suivi pedagogique rigoureux" />
                        ...
                        <div className="flex flex-col lg:items-start items-center gap-3">
                            <Image src={Images.HowItWorkIllustration8} className='h-[12vh] w-auto object-contain' alt="Illustration communication avec les familles" />
