            ...
            <div className='grid grid-rows-1 lg:grid-rows-[1fr_70px] gap-2'>
                <div className={[currentWhyFamilyCarousel?.cardBackgroundColor, "rounded-lg order-0 flex flex-col items-start justify-between p-5"].join(" ")}>
                    <div className="flex flex-col items-start justify-start gap-2">
                        <div className="max-lg:text-[18px] max-lg:font-dm-serif lg:title2">"{currentWhyFamilyCarousel?.title}"</div>
                        <div className="max-lg:text-[14px] max-lg:font-inter lg:simpleText2">{currentWhyFamilyCarousel?.description}</div>
                    </div>
