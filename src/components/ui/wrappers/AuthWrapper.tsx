            ...
            <div className="flex max-lg:flex-col items-center max-lg:justify-start lg:justify-center">
                ...
                <div className="w-full lg:max-w-[50%] flex flex-col items-center justify-start max-lg:gap-8 lg:gap-[3vh]">
                    <div className="flex flex-col items-center justify-start gap-1">
                        <div className="max-lg:text-[24px] lg:text-[1.9vw] lg:leading-[2.3vw] font-dm-serif text-center">{title}</div>
                        <div className="max-lg:text-[14px] lg:text-[.85vw] tracking-[-2%] text-center lg: lg:w-full">{subtitle}</div>
                    </div>
