...
const RoundButton = (props: RoundButtonI) => {
  return (
      <button {...props} className={['shrink-0 h-11 w-11 lg:h-[7.5vh] lg:w-[7.5vh] flex items-center justify-center border rounded-full', props.isActive ? 'border-black cursor-pointer' : 'border-black/50 cursor-not-allowed' ].join(" ")}>
